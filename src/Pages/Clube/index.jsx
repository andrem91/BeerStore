...
export default function PagePedidos(props) {
    ...
    useEffect(()=> {
        async function fethData(){
            const url = "http://localhost/FullStackProject/full-stack-project/src/database/api/clube.php";
    ...
    const controleEnvio = async (evento) => {
        ...
        const resposta = await fetch("http://localhost/FullStackProject/full-stack-project/src/database/api/clube.php", {
            method: "POST",
            body: dados
        } );
